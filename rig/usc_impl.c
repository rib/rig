...
uscript_initRun(UScriptRun *runner,
                const UChar *src,
                int32_t length,
                UErrorCode *pErrorCode)
{
    ...
    uscript_setRunText(runner, src, length, pErrorCode);
...
uscript_closeRun(UScriptRun *runner)
{
    /* NOP */
}
...
U_CAPI void U_EXPORT2
uscript_setRunText(UScriptRun *scriptRun,
                   const UChar *src,
                   int32_t length,
                   UErrorCode *pErrorCode)
{
...
U_CAPI UBool U_EXPORT2
uscript_nextRun(UScriptRun *scriptRun,
                int32_t *pRunStart,
                int32_t *pRunLimit,
