...
#define g_return_if_reached(e) G_STMT_START { g_warning ("%s:%d: code should not be reached, returning!",  __FILE__, __LINE__); return; } G_STMT_END
#define g_return_val_if_reached(e) G_STMT_START { g_warning ("%s:%d: code should not be reached, returning!",  __FILE__, __LINE__); return (e); } G_STMT_END
