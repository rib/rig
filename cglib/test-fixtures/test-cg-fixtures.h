 ...
 * just include <cglib/cglib.h> but since that will only provide
 ...
 *   the texture atlas used by CGlib
 *
 ...
 * cg_texture_allocate() or preferably you can let CGlib
 * automatically allocate the storage lazily when uploading data when
 * CGlib may know more about how the texture will be used and can
 ...
 *         pixel value
 *
 * This performs reads a pixel on the given CGlib @framebuffer and
 ...
 * color
 *
 * Performs a read pixel on the specified region of the given CGlib
